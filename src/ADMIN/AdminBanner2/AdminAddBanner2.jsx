...
function AdminAddBanner2() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('http://localhost:3000/api/banner2', { title: title, description: description, percentage: percentage, offerprice: offerprice, price: price,bannerimage2:bannerimage2 })
        ...
        <div className='flex justify-center items-center ms-4 mt-5'>
            ...
            <div className="relative z-0 w-full mb-5 group">
                ...
                <div className="relative z-0 w-full mb-5 group">
                    ...
                    <label for="desc" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"> Banner Description</label>
                </div>
                <div className="relative z-0 w-full mb-5 group">
                    ...
                    <label for="price" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"> Banner Percentage</label>
                </div>
...
export default AdminAddBanner2
