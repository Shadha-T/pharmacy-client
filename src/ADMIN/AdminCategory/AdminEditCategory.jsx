...
function AdminEditCategory() {
  ...
  const handleSubmit = async(e)=>{
    try {
      const response = await axios.put(`http://localhost:3000/api/category/${id}`,{categoryname:categoryname,categorydescription:categorydescription})
  ...
  useEffect(()=>{
    ...
    setCategorydescription(state?.categorydescription)
  },[])
  return (
    <div>
