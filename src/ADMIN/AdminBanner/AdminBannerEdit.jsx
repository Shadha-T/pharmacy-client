...
function AdminBannerEdit() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.put(`http://localhost:3000/api/banner/${id}`, { title:title, description:description,percentage:percentage, offerprice:offerprice ,price:price})
