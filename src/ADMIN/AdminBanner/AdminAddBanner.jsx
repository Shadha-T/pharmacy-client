...
function AdminAddBanner() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('http://localhost:3000/api/banner', { title: title, description:description,percentage:percentage, offerprice:offerprice ,price:price})
